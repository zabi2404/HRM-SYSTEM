      ...
      <table className="min-w-[1040px] w-full text-white text-sm">
        <thead >
          <tr className='bg-[#212121] '>
            ...
            <th className='w-1/6'>Work Schedule</th>
            <th className='w-1/6'>Logged Time</th>
            <th className='w-1/6'>Paid Time</th>
            <th className='w-1/6'>Over Time</th>
            <th className='w-1/6 rounded-r-lg'>Deficit</th>
