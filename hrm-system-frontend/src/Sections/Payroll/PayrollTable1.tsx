...
export default function PayrollTable1({newAllUserTabledata}) {
      ...
      <table className="min-w-[1040px] w-full text-white text-sm">
        <thead >
          <tr className='bg-[#212121] '>
            ...
            <th className='w-1/6'>Actual</th>
            <th className='w-1/6'>Bonus</th>
            <th className='w-1/6'>Deduction</th>
            <th className='w-1/6 rounded-r-lg'>Off</th>
