...
import { getLeaveBalance,createLeave ,getAppliedLeave,getAppliedLeaves,updateLeave, deleteLeave, LeaveByid, UserUpdateLeave} from '../Controllers/LeaveController.js';
...
Router.post('/Employeeupdate-leave/:id',VerifyToken,UserUpdateLeave) 
